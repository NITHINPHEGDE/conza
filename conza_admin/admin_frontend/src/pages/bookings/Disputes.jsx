...
const mockDisputes = [
  { id: 'D001', bookingId: 'BK005', customer: 'Meena T', worker: 'Suresh Kumar', issue: 'Worker was rude', amount: 535, status: 'open', priority: 'high' },
  { id: 'D002', bookingId: 'BK003', customer: 'Ananya R', worker: 'Ravi Kumar', issue: 'Incomplete work', amount: 960, status: 'in_progress', priority: 'medium' },
]
...
export default function Disputes() {
  ...
  return (
    <div className="space-y-4">
      <Breadcrumb items={[{ label: 'Bookings', path: '/bookings' }, { label: 'Disputes' }]} />
      <h1 className="text-2xl font-bold text-textPrimary">Booking Disputes</h1>
