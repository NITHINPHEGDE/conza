...
export default function EditCategory() {
  ...
  const [form, setForm] = useState({ name: '', commission: '', radius: '', description: '', active: true, baseCharge: '0', perHourCharge: '0', perDayCharge: '0' })
    ...
    const load = async () => {
      try {
        ...
        setForm({
          ...
          baseCharge:    category.baseCharge    ?? 0,
