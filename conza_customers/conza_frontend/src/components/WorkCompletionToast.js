...
// Global bottom banner: appears no matter what screen the customer is on
// when a worker marks a job "Work Completed" (autobook or manual booking).
// Tapping it navigates to the Status tab → that booking's detail screen,
// where the existing "Confirm Work Completion" modal (BookingTrackingScreen,
// driven by activeBooking.status === 'awaiting_customer_confirmation')
// takes over so the customer can actually confirm/report an issue.
