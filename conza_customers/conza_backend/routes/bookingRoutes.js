...
const { createBooking, createAutobookBooking, getMyBookings, getBookingById, cancelBooking, confirmCompletion, reportIssue, submitReview, getLabourBillPreview, updateBookingNotes, getBookingPayment, payBooking } = require('../controllers/bookingController');
...
router.get('/:id/payment', protect, getBookingPayment);
router.post('/:id/pay', protect, checkSuspended, payBooking);
...
router.patch('/:id/notes', protect, checkSuspended, updateBookingNotes);
