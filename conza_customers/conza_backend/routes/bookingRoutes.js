...
const { createBooking, createAutoBooking, getMyBookings, getBookingById, cancelBooking, cancelAutoBooking, confirmCompletion, reportIssue, confirmPartialAutoBook, cancelPartialAutoBook } = require('../controllers/bookingController');
...
router.patch('/:id/cancel-auto', protect, checkSuspended, cancelAutoBooking);
