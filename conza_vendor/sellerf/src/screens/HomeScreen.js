...
const HomeScreen = () => {
  ...
  const { vendor, kpi, chartData, getFilteredOrders } = useVendorStore();

  useEffect(() => { loadMode(); }, []);

  const orders = getFilteredOrders(mode);
        ...
        <View style={styles.topRight}>
          <View style={styles.walletBadge}>
            ...
            <Text style={styles.walletAmount}>
              ₹{vendor.walletBalance.toLocaleString('en-IN')}
            </Text>
          </View>
        ...
        >
          <View style={styles.earningsLeft}>
            ...
            <Text style={styles.earningsAmount}>
              ₹{vendor.monthEarnings.toLocaleString('en-IN')}
            </Text>
          </View>
          <View style={styles.growthBadge}>
            <Text style={styles.growthText}>{vendor.growth}</Text>
