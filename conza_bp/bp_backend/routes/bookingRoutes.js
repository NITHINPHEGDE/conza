...
const { getWorkerRequests, acceptAutobookRequest, updateBookingStatus, getWorkerHistory, getBookingById, getEarningEstimate } = require('../controllers/bookingController');
